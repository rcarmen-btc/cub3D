...
#    Updated: 2021/03/31 11:25:05 by rcarmen          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = main.c parsing.c trgb.c raycasting.c validation_utils.c floodfill.c textures_utils.c sprite_utils.c free_utils.c parsing_utils.c init_utils.c free.c init.c hooks.c save.c shapaes.c bresenham.c error.c validation.c textures.c utils.c sprite.c
