...
SRC = main.c parsing.c trgb.c raycasting.c textures_utils.c free_utils.c parsing_utils.c init_utils.c free.c init.c hooks.c save.c shapaes.c bresenham.c error.c validation.c textures.c utils.c sprite.c
